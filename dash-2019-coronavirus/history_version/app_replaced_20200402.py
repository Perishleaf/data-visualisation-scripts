...
app = dash.Dash(__name__,
                ...
                meta_tags=[
                    ...
                    {"name": "keywords", "content": "COVID-19, dashborad, global cases, coronavirus, monitor, real time, 世界，疫情, 冠状病毒, 肺炎, 新型肺炎, 最新疫情, 实时疫情, 疫情地图, 疫情"},
                    {"name": "description", "content": "The coronavirus COVID-19 monitor/dashboard provides up-to-date data, map, cumulative curve, growth trajectory for the global spread of coronavirus.\
