...
fig_death_curve_tab.update_yaxes(range=[0, 5.3])
                 ...
                 children=[
                     ...
                     html.P(style={'textAlign': 'center', 'margin': 'auto'},
                            children=['Keep calm and stay home | ',
                                      ...
                                      html.A('COVID-19 infographic in Australia', href='https://www.health.gov.au/sites/default/files/documents/2020/04/coronavirus-covid-19-at-a-glance-coronavirus-covid-19-at-a-glance-infographic_5.pdf', target='_blank'),
...
def update_deathplot(value, derived_virtual_selected_rows, selected_row_ids,
  ...
  US_derived_virtual_selected_rows, US_selected_row_ids
    ...
    fig_curve_death.update_yaxes(range=[0, 5.3])
