      ...
      return dcc.Tab(
               ...
               children=[dash_table.DataTable(
                    ...
                    columns=[{"name": i, "id": i, "type": "numeric","format": FormatTemplate.percentage(2)}
                             ...
                             for i in [dataframe.columns[0], dataframe.columns[2]]+ list(dataframe.columns[4:6])],
                    ...
                    style_header={'backgroundColor': '#ffffff',
                                  'fontWeight': 'bold'},
                    style_cell_conditional=[{'if': {'column_id': 'Province/State'}, 'width': '46%'},
                                            {'if': {'column_id': 'Country/Region'}, 'width': '46%'},
                                            #{'if': {'column_id': 'Active'}, 'width': '15.6%'},
                                            {'if': {'column_id': 'Confirmed'}, 'width': '18.9%'},
                                            #{'if': {'column_id': 'Recovered'}, 'width': '15.6%'},
                                            {'if': {'column_id': 'Deaths'}, 'width': '17.5%'},
                                            {'if': {'column_id': 'Death rate'}, 'width': '17.2%'},
      ...
      return dcc.Tab(
               ...
               children=[dash_table.DataTable(
                    ...
                    style_cell_conditional=[{'if': {'column_id': 'Province/State'}, 'width': '26%'},
                                            ...
                                            {'if': {'column_id': 'Confirmed'}, 'width': '15.6%'},
                                            {'if': {'column_id': 'Recovered'}, 'width': '15.6%'},
                                              ...
                                              children=[
                                                  dash_table.DataTable(
                                                      ...
                                                      style_cell_conditional=[{'if': {
                                                                              ...
                                                                              {'if': {
                                                                                  'column_id': 'Active'}, 'width': '13.8%'},
                                                                              {'if': {
                                                                                  'column_id': 'Confirmed'}, 'width': '15.4%'},
                                                                              {'if': {
                                                                                  'column_id': 'Recovered'}, 'width': '15.4%'},
                                                                              {'if': {
                                                                                  'column_id': 'Deaths'}, 'width': '13.8%'},
                                                                              {'if': {
                                                                                  'column_id': 'Death rate'}, 'width': '13.8%'},
                                                                              {'if': {
...
def update_figures(value, derived_virtual_selected_rows, selected_row_ids, 
  ...
  US_derived_virtual_selected_rows, US_selected_row_ids
    ...
    if value == 'The World':
      ...
      hovertext_value = ['Confirmed: {:,d}<br>Recovered: {:,d}<br>Death: {:,d}<br>Death rate: {:.2%}'.format(i, j, k, t) 
                          for i, j, k, t in zip(df_latest['Confirmed'], df_latest['Recovered'], df_latest['Deaths'], df_latest['Deaths']/df_latest['Confirmed'])]
      ...
      hovertext_value = ['Confirmed: {:,d}<br>Death: {:,d}<br>Death rate: {:.2%}'.format(i, k, t) 
                          for i, k, t in zip(df_latest['Confirmed'], df_latest['Deaths'], df_latest['Deaths']/df_latest['Confirmed'])]
