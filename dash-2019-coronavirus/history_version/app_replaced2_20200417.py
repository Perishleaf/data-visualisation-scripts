...
def make_europe_table(europe_list):
  ...
  europe_table['Positive rate'] = europe_table['Confirmed']/europe_table['Tests']
  europe_table['Tests/100k'] = ((europe_table['Tests']/europe_table['Population'])*100000).round()

  europe_table = europe_table[['Country/Region', 'Active', 'Confirmed', 'Recovered', 'Deaths', 'Death rate', 'Tests', 'Positive rate', 'Tests/100k', 'Confirmed/100k', 'lat', 'lon','Population']]
  ...
  europe_table = europe_table.replace({'Tests': 0, 'Positive rate':0, 'Tests/100k':0}, 'N/A')
